...
export default function Hero() {
  const handleScrollDown = () => {
    ...
    if (target) {
      ...
      // fallback: just scroll one viewport height down
    ...
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="container-page py-14 lg:py-16">
        <div className="grid lg:grid-cols-2 items-center gap-8 lg:gap-10">
          {/* Left Side */}
          <div>
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-[#1F2147]">
              Stand Out
              <br />
              from The
              <br />
            ...
            <button
              ...
              className="mt-10 flex items-center gap-3 text-gray-500 cursor-pointer group"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#B98AF5] text-white transition-transform duration-300 group-hover:translate-y-1">
                <ArrowDown size={18} />
              </div>
          ...
          <div className="relative flex justify-center">
            {/* Purple Shape */}
            <div className="absolute right-2 top-6 h-[360px] w-[320px] rounded-[32px] bg-[#C89BF5] -z-10"></div>
